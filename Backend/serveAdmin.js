const { readDB, updateDB } = require("./src/db/MongoOperations.js")
const fs = require("fs")
...
function getTargetActivityRoute(req, res) {
...
function DeleteImageRoute(req, res) {
...
function getTargetsRoute(req, res) {
...
function updatePermissionsRoute(req, res) {
...
module.exports = { getTargetActivityRoute, DeleteImageRoute, getTargetsRoute, updatePermissionsRoute }